...
#include "luascript.h"
#include "const.h"
#include "creature.h" // Item tier system
...
class Events
{
	struct EventsInfo {
		...
		int32_t playerOnInventoryUpdate = -1; // Item tier system
	...
	public:
		...
		void eventPlayerOnInventoryUpdate(Player* player, Item* item, slots_t slot, bool equip); // Item tier system
